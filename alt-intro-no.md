---
title: Introduction to Web Accessibility - without intro
permalink: /fundamentals/accessibility-intro/alt-intro-no
layout: default
github:
...
<p class="box-h box-h-simple box-h-full">Related Resource:<br>
